...
- (void)awakeFromNib {
    ...
    webshows = [[NSArray alloc] initWithContentsOfFile:path];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSArray *temp = [webshows objectAtIndex:indexPath.row];
    //start at the first part of our array
